  ...
  const features = [
    {
      ...
      description: "Learn while you play with carefully curated questions designed specifically for young learners.",
    ...
    },
    {
      icon: Award,
      title: "Achievements",
      description: "Unlock cool badges and climb leaderboards as you master different subjects.",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: Users,
      title: "Safe Community",
      description: "Join a safe, moderated community of young learners and compete in fun tournaments.",
      color: "from-purple-500 to-purple-600",
    },
    {
      icon: TrendingUp,
      title: "Progress Tracking",
      description: "Parents and kids can monitor learning progress with comprehensive statistics.",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-red-200/50 mb-8 shadow-lg">
            ...
            <span className="text-red-700 text-sm font-medium">About Our Platform</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            QuizMaster is designed to make learning fun and engaging for kids. Whether your child is curious about
            science, loves history, or enjoys fun facts, our platform offers an exciting way to learn and grow while
            having a blast!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div className="relative bg-white/60 backdrop-blur-xl rounded-2xl p-8 border border-red-200/50 hover:border-red-300/50 transition-all duration-500 hover:transform hover:scale-105 hover:bg-white/80 shadow-lg hover:shadow-xl">
                  <div
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-4 group-hover:text-red-700 transition-colors">
                    {feature.title}
                  </h3>
        ...
        <div className="relative">
          <div className="bg-gradient-to-r from-red-100/80 via-white/80 to-red-100/80 rounded-3xl p-12 backdrop-blur-xl border border-red-200/50 shadow-2xl">
            <div className="text-center mb-12">
              <h3 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Join the Learning Adventure</h3>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                { number: "10,000+", label: "Fun Questions", icon: BookOpen },
                ...
                return (
                  ...
                  >
                    <div className="inline-flex items-center justify-center w-12 h-12 bg-red-100 rounded-xl mb-4 group-hover:bg-red-200 transition-colors">
